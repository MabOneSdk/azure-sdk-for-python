...
class BackupStorageConfigsOperations(object):
    ...
    def get(
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('BackupStorageConfig', response)
    ...
    def update(
            self, resource_group_name, vault_name, backup_storage_config, custom_headers=None, raw=False, **operation_config):
        ...
        # Construct body
        body_content = self._serialize.body(backup_storage_config, 'BackupStorageConfig')
